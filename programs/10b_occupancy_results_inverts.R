...
coef(cipa.occ.e.NB, type="gamma")
confint(cipa.occ.e.NB, type="gamma", level=0.85)
coef(cipa.occ.e.NB, type="epsilon")
confint(cipa.occ.e.NB, type="epsilon", level=0.85)
cipa.occ.e.NB
...
coef(cipa.occ.c.NB, type="gamma")
confint(cipa.occ.c.NB, type="gamma", level=0.85)
coef(cipa.occ.c.NB, type="epsilon")
confint(cipa.occ.c.NB, type="epsilon", level=0.85)
cipa.occ.c.NB
...
coef(cipa.occ.null.NB, type="gamma")
confint(cipa.occ.null.NB, type="gamma", level=0.85)
coef(cipa.occ.null.NB, type="epsilon")
confint(cipa.occ.null.NB, type="epsilon", level=0.85)
cipa.occ.null.NB
...
coef(cipa.occ.l.NB, type="gamma")
confint(cipa.occ.l.NB, type="gamma", level=0.85)
coef(cipa.occ.l.NB, type="epsilon")
confint(cipa.occ.l.NB, type="epsilon", level=0.85)
cipa.occ.l.NB
...
coef(hele.occ.t.NB, type="gamma")
confint(hele.occ.t.NB, type="gamma", level=0.85)
coef(hele.occ.t.NB, type="epsilon")
confint(hele.occ.t.NB, type="epsilon", level=0.85)
hele.occ.t.NB
...
coef(hele.occ.null.NB, type="gamma")
confint(hele.occ.null.NB, type="gamma", level=0.85)
coef(hele.occ.null.NB, type="epsilon")
confint(hele.occ.null.NB, type="epsilon", level=0.85)
hele.occ.null.NB
...
coef(hele.occ.nb.NB, type="gamma")
confint(hele.occ.nb.NB, type="gamma", level=0.85)
coef(hele.occ.nb.NB, type="epsilon")
confint(hele.occ.nb.NB, type="epsilon", level=0.85)
hele.occ.nb.NB
...
coef(hele.occ.l.NB, type="gamma")
confint(hele.occ.l.NB, type="gamma", level=0.85)
coef(hele.occ.l.NB, type="epsilon")
confint(hele.occ.l.NB, type="epsilon", level=0.85)
hele.occ.l.NB
...
coef(hele.occ.b.NB, type="gamma")
confint(hele.occ.b.NB, type="gamma", level=0.85)
coef(hele.occ.b.NB, type="epsilon")
confint(hele.occ.b.NB, type="epsilon", level=0.85)
hele.occ.b.NB
...
coef(hele.occ.c.NB, type="gamma")
confint(hele.occ.c.NB, type="gamma", level=0.85)
coef(hele.occ.c.NB, type="epsilon")
confint(hele.occ.c.NB, type="epsilon", level=0.85)
hele.occ.c.NB
...
coef(hele.occ.d.NB, type="gamma")
confint(hele.occ.d.NB, type="gamma", level=0.85)
coef(hele.occ.d.NB, type="epsilon")
confint(hele.occ.d.NB, type="epsilon", level=0.85)
hele.occ.d.NB
